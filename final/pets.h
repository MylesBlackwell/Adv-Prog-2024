...
public:
    Mammals(string name, int age, int energyLevel) : Pets(name, age){
...
class Dog : public Mammals {
    public:
    //constuctor
    Dog(string name,  int age, int energyLevel) : Mammals(name, age, energyLevel){
...
public:
    //Constructor
    Cat(string name, int age, int energyLevel) : Mammals(name, age, energyLevel) {
        cout << "You now have a " << age << " year old cat named " << name << endl;
    }
...
class Aquatic : public Pets {
protected:
    string division;

public:
    Aquatic(string name, int age) : Pets(name, age) {
        division = "Aquatic";
    }
...
class Goldfish: public Aquatic{
public:
    Goldfish(string name, int age):Aquatic(name, age) {
        type = "goldfish";
    }
